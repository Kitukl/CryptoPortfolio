...
public record UploadCoinsCommand() : IRequest;

public class UploadCoinsCommandHandler : IRequestHandler<UploadCoinsCommand>
{
    ...
    public async Task Handle(UploadCoinsCommand request, CancellationToken cancellationToken)
        {
